...
def bit_create_tests(size: int, directory_name: str):
    """
    size:  
    ...
    Path(f'{PATH}/files/{directory_name}').mkdir(exist_ok=True)
...
=======
    bit_create_tests(8)
>>>>>>> 700835de6d9022da7b040f0dee4dcb2c99bb4fed
